...
Portanto, para realizar push e pull para o repositório no GitHub é necessário configurar o agente SSH na máquina.
...
Através do link do repositório é possível realizar um clone do mesmo em diretório em uma máquina local, assim permitindo push e pull no repositório.
...
&xrArr; Na página inicial do projeto é possível visualizar itens relativos a informações como commits, tags e branches. Estas opções permitem navegar no projeto de forma visual similar ao uso de checkout no terminal.
...
&xrArr; Após inicializar um repositório através de um fork, é possível clonar o repositório em uma máquina local.

&xrArr; O comando a seguir permite definir, além do repositório do fork, o repositório original como origem. Desta forma, alterações no repositório original também serão incluídas:
...
[Documentação Gists](https://docs.github.com/en/get-started/writing-on-github/editing-and-sharing-content-with-gists/creating-gists)
